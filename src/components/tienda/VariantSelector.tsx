  ...
  if (!variante) {
    return (
      <div className="space-y-4">
        ...
        <a
          href={`https://wa.me/56928254899?text=${encodeURIComponent(`Hola Casa Turquesa, me interesa el producto "${productoNombre}"${productoMarca ? ` de ${productoMarca}` : ''} y quería consultar disponibilidad.`)}`}
          target="_blank"
    ...
    <div className="space-y-6">
      ...
      {!sinStock && (
        <p className="text-xs text-neutral-500 italic">
          ...
          <a
            href={`https://wa.me/56928254899?text=${encodeURIComponent(`Hola Casa Turquesa, me interesa el producto "${productoNombre}"${productoMarca ? ` de ${productoMarca}` : ''}.`)}`}
            target="_blank"
            rel="noopener noreferrer"
